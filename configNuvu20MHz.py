...
import controlNuvu
txt=controlNuvu.ControlNuvu("",0).setClockRateTxt(20)
camCommand="PixelFormat=Mono16;Uart0BaudRate=Baud115200;GevSCPSPacketSize=8164;%sR[0xB84C]=114;R[0xB84C]=101;R[0xB84C]=32;R[0xB84C]=45;R[0xB84C]=49;R[0xB84C]=10;"%txt
